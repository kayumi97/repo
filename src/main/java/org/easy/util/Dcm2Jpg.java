...
public class Dcm2Jpg {
    ...
    public static void converter(File dcm, File jpg) {
        List<String> list = new ArrayList<>();
    	
        list.add(dcm.getAbsolutePath());
        list.add(jpg.getAbsolutePath());
    	
    	Dcm2Jpg.converter(list.toArray(new String[0]));

    }
    
    public static void main(String[] args) {
    	Dcm2Jpg.converter(args);
	}
