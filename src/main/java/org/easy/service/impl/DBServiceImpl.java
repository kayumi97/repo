...
public class DBServiceImpl implements DBService {
	...
	@Transactional
	@Override
	public Instance buildInstance(DicomReader reader, Series series, String sender){
		...
		if(instance == null){//let's create new instance along with dependent objects
			instance = DicomEntityBuilder.newInstance(  reader.getAcquisitionDateTime(), reader.getContentDateTime(), reader.getExposureTime(),
						...
						sender+"_"+reader.getMediaStorageSopInstanceUID(), reader.getPatientOrientation(), reader.getPixelSpacing(), reader.getSliceLocation(),
	...
	@Transactional
	@Override
	public void buildEntities(DicomReader reader, String sender){
			...
			{				
				...
				if(study != null){
					...
					if(series != null){
						...
						Instance instance = buildInstance(reader, series, sender);
